...
export default function Donate() {
    ...
    const charities = [
        { id: 1, name: 'Komuniteti Mbështetës i Kancerit në Kosovë', image: "../src/assets/images/CSCkosovo.png" },
        { id: 2, name: 'Kryqi i Kuq i Kosovës', image: "../src/assets/images/kryqi.png" },
        { id: 3, name: 'Shoqata e të Verbërve të Kosovës', image: "../src/assets/images/blindfederate.png" },
        { id: 4, name: 'YMCA Kosovo', image: "../src/assets/images/ymca.jpg" },
        { id: 5, name: 'Save the Children Kosovo', image: "../src/assets/images/savethechildren.jpg" },
        { id: 6, name: 'UNICEF Kosovo', image: "../src/assets/images/unicef.png" },
        { id: 7, name: 'Fondacioni për të Drejtat e Kafshëve', image: "../src/assets/images/kafshet.jpg" },
        { id: 8, name: 'Qendra për Promovimin e Drejtave të Grave', image: "../src/assets/images/women.png" },
        { id: 9, name: 'HANDIKOS', image: "../src/assets/images/handikos.png" },
